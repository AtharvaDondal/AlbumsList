...
export default class App extends Component {
  ...
  //this function takes album id, updateTitle, updateUserid, oldAlbum and then update and set state 
  ...
  //this function takes userid and title from input and then added to the bottom of the albums list
